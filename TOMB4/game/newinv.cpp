...
{
	INJECT(0x0043B710, LoadGame, replace);
	INJECT(0x0043B730, SaveGame, replace);
	INJECT(0x0043B9B0, init_new_inventry, replace);
	INJECT(0x0043BC30, do_debounced_joystick_poo, replace);
	INJECT(0x0043BF10, DrawInventoryItemMe, replace);
	INJECT(0x0043BD80, DrawThreeDeeObject2D, replace);
	INJECT(0x0043C400, go_and_load_game, replace);
	INJECT(0x0043C410, go_and_save_game, replace);
	INJECT(0x0043C5A0, insert_object_into_list_v2, replace);
	INJECT(0x0043C420, construct_combine_object_list, replace);
	INJECT(0x0043CA90, insert_object_into_list, replace);
	INJECT(0x0043C610, construct_object_list, replace);
	INJECT(0x0043D450, handle_object_changeover, replace);
	INJECT(0x0043DE30, fade_ammo_selector, replace);
	INJECT(0x0043E140, spinback, replace);
	INJECT(0x0043E1B0, update_laras_weapons_status, replace);
	INJECT(0x0043E2F0, have_i_got_item, replace);
	INJECT(0x0043E420, combine_revolver_lasersight, replace);
	INJECT(0x0043E480, combine_crossbow_lasersight, replace);
	INJECT(0x0043E4E0, combine_PuzzleItem1, replace);
	INJECT(0x0043E500, combine_PuzzleItem2, replace);
	INJECT(0x0043E520, combine_PuzzleItem3, replace);
	INJECT(0x0043E540, combine_PuzzleItem4, replace);
	INJECT(0x0043E560, combine_PuzzleItem5, replace);
	INJECT(0x0043E580, combine_PuzzleItem6, replace);
	INJECT(0x0043E5A0, combine_PuzzleItem7, replace);
	INJECT(0x0043E5C0, combine_PuzzleItem8, replace);
	INJECT(0x0043E5E0, combine_KeyItem1, replace);
	INJECT(0x0043E600, combine_KeyItem2, replace);
	INJECT(0x0043E620, combine_KeyItem3, replace);
	INJECT(0x0043E640, combine_KeyItem4, replace);
	INJECT(0x0043E660, combine_KeyItem5, replace);
	INJECT(0x0043E680, combine_KeyItem6, replace);
	INJECT(0x0043E6A0, combine_KeyItem7, replace);
	INJECT(0x0043E6C0, combine_KeyItem8, replace);
	INJECT(0x0043E6E0, combine_PickupItem1, replace);
	INJECT(0x0043E700, combine_PickupItem2, replace);
	INJECT(0x0043E720, combine_PickupItem3, replace);
	INJECT(0x0043E740, combine_PickupItem4, replace);
	INJECT(0x0043E760, combine_ClockWorkBeetle, replace);
	INJECT(0x0043E770, do_special_waterskin_combine_bullshit, replace);
	INJECT(0x0043E830, setup_objectlist_startposition, replace);
	INJECT(0x0043E860, setup_objectlist_startposition2, replace);
	INJECT(0x0043EF60, have_i_got_object, replace);
	INJECT(0x0043F050, remove_inventory_item, replace);
	INJECT(0x0043F150, convert_obj_to_invobj, replace);
	INJECT(0x0043F180, draw_compass, replace);
	INJECT(0x0043F1E0, do_examine_mode, replace);
	INJECT(0x0043F4C0, dels_give_lara_items_cheat, replace);
	INJECT(0x0043E8A0, use_current_item, replace);
	INJECT(0x0043EB80, DEL_picked_up_object, replace);
	INJECT(0x0043E250, is_item_currently_combinable, replace);
	INJECT(0x0043E320, do_these_objects_combine, replace);
	INJECT(0x0043E360, combine_these_two_objects, replace);
	INJECT(0x0043E3D0, seperate_object, replace);
	INJECT(0x0043DED0, draw_ammo_selector, replace);
	INJECT(0x0043D470, handle_inventry_menu, replace);
	INJECT(0x0043CAE0, draw_current_object_list, replace);
	INJECT(0x0043B760, S_CallInventory2, replace);
}

...
void twentythree_end()
{
	...
	lara.questitems &= 1;	//as del would say, nail amulet
}
...
void inject_deltapack(bool replace)
{
	...
	INJECT(0x0046ABE0, do_new_cutscene_camera, replace);
	INJECT(0x0046AD70, InitPackNodes, replace);
	INJECT(0x0046AE80, DecodeAnim, replace);
	INJECT(0x0046AFA0, DecodeTrack, replace);
	INJECT(0x0046B0D0, GetTrackWord, replace);
	INJECT(0x0046B140, frigup_lara, replace);
	INJECT(0x0046B220, updateAnimFrame, replace);
	INJECT(0x0046B290, cutseq_malloc, replace);
	INJECT(0x0046B2A0, finish_cutseq, replace);
	INJECT(0x0046B2B0, DrawCutSeqActors, replace);
	INJECT(0x0046B4C0, CalcActorLighting, replace);
	INJECT(0x0046B560, GetJointAbsPositionCutSeq, replace);
	INJECT(0x0046B600, CalculateObjectLightingLaraCutSeq, replace);
	INJECT(0x0046B6D0, third_cutseq_control, replace);
	INJECT(0x0046B6F0, fourth_cutseq_init, replace);
	INJECT(0x0046B710, fourth_cutseq_control, replace);
	INJECT(0x0046B7E0, fourth_cutseq_end, replace);
	INJECT(0x0046B800, fifth_cutseq_control, replace);
	INJECT(0x0046B820, fifth_cutseq_end, replace);
	INJECT(0x0046B840, sixth_cutseq_init, replace);
	INJECT(0x0046B850, sixth_cutseq_control, replace);
	INJECT(0x0046B880, sixth_cutseq_end, replace);
	INJECT(0x0046B8A0, seventh_cutseq_init, replace);
	INJECT(0x0046B8C0, seventh_control, replace);
	INJECT(0x0046B8F0, eighth_control, replace);
	INJECT(0x0046B920, ninth_cutseq_init, replace);
	INJECT(0x0046B980, ninth_control, replace);
	INJECT(0x0046BA40, tenth_cutseq_init, replace);
	INJECT(0x0046BA90, tenth_cutseq_control, replace);
	INJECT(0x0046BC00, tenth_cutseq_end, replace);
	INJECT(0x0046BC30, eleventh_cutseq_init, replace);
	INJECT(0x0046BCE0, eleventh_cutseq_control, replace);
	INJECT(0x0046BED0, twelth_cutseq_init, replace);
	INJECT(0x0046BEE0, twelth_cutseq_end, replace);
	INJECT(0x0046BEF0, thirteen_end, replace);
	INJECT(0x0046BF10, fourteen_end, replace);
	INJECT(0x0046BF40, fourteen_control, replace);
	INJECT(0x0046BF70, fifteen_init, replace);
	INJECT(0x0046C020, fifteen_control, replace);
	INJECT(0x0046C190, fifteen_end, replace);
	INJECT(0x0046C1A0, sixteen_init, replace);
	INJECT(0x0046C250, sixteen_control, replace);
	INJECT(0x0046C3C0, sixteen_end, replace);
	INJECT(0x0046C410, seventeen_control, replace);
	INJECT(0x0046C440, seventeen_end, replace);
	INJECT(0x0046C470, eighteen_init, replace);
	INJECT(0x0046C480, eighteen_control, replace);
	INJECT(0x0046C4B0, eighteen_end, replace);
	INJECT(0x0046C4E0, nineteen_init, replace);
	INJECT(0x0046C500, nineteen_control, replace);
	INJECT(0x0046C530, nineteen_end, replace);
	INJECT(0x0046C560, twenty_control, replace);
	INJECT(0x0046C590, twenty_end, replace);
	INJECT(0x0046C5C0, twentyone_init, replace);
	INJECT(0x0046C5E0, twentyone_end, replace);
	INJECT(0x0046C610, twentythree_init, replace);
	INJECT(0x0046C630, twentythree_control, replace);
	INJECT(0x0046C700, twentythree_end, replace);
	INJECT(0x0046C730, twentyfour_init, replace);
	INJECT(0x0046C760, twentyfour_control, replace);
	INJECT(0x0046C7C0, twentyfour_end, replace);
	INJECT(0x0046C7E0, twentyfive_control, replace);
	INJECT(0x0046C820, twentyfive_end, replace);
	INJECT(0x0046C880, twentyfive_init, replace);
	INJECT(0x0046C8D0, twentysix_control, replace);
	INJECT(0x0046C900, twentyseven_init, replace);
	INJECT(0x0046C930, twentyseven_control, replace);
